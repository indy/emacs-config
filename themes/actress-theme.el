...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(helm-ff-dotted-symlink-directory ((,class (:foreground ,directory :background ,bg1 :weight bold))))
   `(helm-ff-dotted-directory ((,class (:foreground ,directory :background ,bg1 :weight bold))))
   `(helm-ff-directory ((,class (:foreground ,directory :background ,bg1 :weight bold))))
   `(helm-ff-executable ((,class (:foreground ,executable :background ,bg1 :weight normal))))
   ...
   `(helm-selection ((,class (:foreground ,bg1 :background ,fg2 :underline nil))))
