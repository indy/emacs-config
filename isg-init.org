...
#+BEGIN_SRC emacs-lisp
  (isg/time-section "-helper-functions")
...
#+BEGIN_SRC emacs-lisp
(isg/time-section "-windows-home-pc")
...
#+BEGIN_SRC emacs-lisp
(isg/time-section "-old-ubuntu-laptop")
...
#+BEGIN_SRC emacs-lisp
(isg/time-section "-ivy/swiper/counsel")
  (use-package ivy
    :demand t
    :delight
    :config
...
#+BEGIN_SRC emacs-lisp
(isg/time-section "-haskell-config")
...
#+BEGIN_SRC emacs-lisp
  (isg/time-section "-spaceline-config")
  ...
  ;; if the separate is going to be changed then spaceline-compile needs to be called
  ;; this increases load time by 1s
